...
def parse_arguments(parser):
    ...
    parser.add_argument('-o', '--org', default=org_id, required=False, help='Dashboard organization ID')
    parser.add_argument('-k', '--key', default=api_key, required=False, help='Dashboard API key')
